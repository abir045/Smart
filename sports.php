...
<body>
    ...
    <div>
        ...
        <section id="stay" class="flex flex-col">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="flex mx-[5%]">
                    <div class="grid  grid-cols-1 md:grid-cols-4 ">
                        ...
                        <?php while ($sports_row = $sportsProducts->fetch_assoc()) { ?>

                            <div class="justify-evenly mx-2 Products">
                                <div class="flex flex-col space-y-5 items-center my-5  drop-shadow-lg">
                                    <div class="flex flex-col space-y-5 items-center my-5  drop-shadow-lg ">
                                        <img class="flex" src="<?php echo $sports_row['img'] ?>" />
                                        <h2 class="text-xl font-bold tracking-wider"><?php echo $sports_row['title'] ?></h2>
                                        <hr class="mx-auto bg-sky-400 h-[2px] w-[85%]" />
                                        <h2 class="text-xl font-semibold tracking-widest opacity-40"><?php echo $sports_row['dsc'] ?></h2>
                                        <h3 class="text-xl font-medium opacity-70">€<?php echo $sports_row['price'] ?></h3>

                                        <!-- redirect to single product page by clicking buy -->
                                        <a href="<?php echo 'single_product.php?id=' . $sports_row['id'] ?>">
                ...
                <div class="flex mx-[10%] justify-between space-x-5 mb-[5%]">
                    ...
                    $total_pages = ceil($sports_total_rows / $sports_limit);

                    $pageURL = "";


                    if ($sports_page_number >= 2) {
                        echo "<a href='sports.php?page=" . ($sports_page_number - 1) . "'>Prev</a>";
                    }

                    for ($i = 1; $i <= $total_pages; $i++) {

                        if ($i == $sports_page_number) {

                            $pageURL .= "<a class = 'active' href='sports.php?page="

                                . $i . "'>" . $i . " </a>";
                        } else {

                            $pageURL .= "<a href='sports.php?page=" . $i . "'>   
                    ...
                    if ($sports_page_number < $total_pages) {

                        echo "<a href='sports.php?page=" . ($sports_page_number + 1) . "'>  Next </a>";
                    }
