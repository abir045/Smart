        ...
        <section class="flex flex-col" id="stay">
            ...
            <div class="flex flex-col items-center">
                            ...
                            <div class="justify-evenly mx-2">
                                <div class="flex flex-col space-y-5 items-center my-5  drop-shadow-lg">
                                    <div class="flex flex-col space-y-5 items-center my-5  drop-shadow-lg Products">
                                        ...
                                        <h2 class="text-xl font-semibold tracking-widest opacity-40"><?php echo $spa_row['dsc'] ?></h2>
                                        <h3 class="text-xl font-medium opacity-70">€<?php echo $spa_row['price'] ?></h3>

                                        <!-- redirect to single product page by clicking buy -->
                                        <a href="<?php echo 'single_product.php?id=' . $spa_row['id'] ?>">
                ...
                <div class="flex mx-[10%] justify-between space-x-5 mb-[5%]">
                    ...
                    $total_pages = ceil($spa_total_rows / $spa_limit);

                    $pageURL = "";


                    if ($spa_page_number >= 2) {
                        echo "<a href='multi-themes.php?page=" . ($spa_page_number - 1) . "'>Prev</a>";
                    }

                    for ($i = 1; $i <= $total_pages; $i++) {

                        if ($i == $spa_page_number) {

                            $pageURL .= "<a class = 'active' href='spa.php?page="

                                . $i . "'>" . $i . " </a>";
                        } else {

                            $pageURL .= "<a href='spa.php?page=" . $i . "'>   
                    ...
                    if ($spa_page_number < $total_pages) {

                        echo "<a href='spa.php?page=" . ($spa_page_number + 1) . "'>  Next </a>";
                    }
